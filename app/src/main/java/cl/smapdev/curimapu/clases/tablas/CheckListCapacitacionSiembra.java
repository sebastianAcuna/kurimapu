...
@Entity(tableName = "anexo_checklist_capacitacion_siembra")
public class CheckListCapacitacionSiembra {

    @SerializedName("id_cl_cap_siembra")
    @PrimaryKey(autoGenerate = true)
    @Expose
    private int id_cl_cap_siembra;
    ...
    public void setImpartidor(String impartidor) {
        this.impartidor = impartidor;
    }

    public int getId_cl_cap_siembra() {
        return id_cl_cap_siembra;
    }

    public void setId_cl_cap_siembra(int id_cl_cap_siembra) {
        this.id_cl_cap_siembra = id_cl_cap_siembra;
    }

    public int getId_ac_cl_cap_siembra() {
        return id_ac_cl_cap_siembra;
    }

    public void setId_ac_cl_cap_siembra(int id_ac_cl_cap_siembra) {
        this.id_ac_cl_cap_siembra = id_ac_cl_cap_siembra;
    }
