...
public class Harvest {
    ...
    private int id_visita_harvest;
    private int estado_server_harvest;
    ...
    public int getId_visita_harvest() {
        return id_visita_harvest;
    }

    public void setId_visita_harvest(int id_visita_harvest) {
        this.id_visita_harvest = id_visita_harvest;
    }

    public int getEstado_server_harvest() {
        return estado_server_harvest;
    }

    public void setEstado_server_harvest(int estado_server_harvest) {
        this.estado_server_harvest = estado_server_harvest;
    }
