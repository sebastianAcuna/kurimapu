...
public interface DaoSitiosNoVisitados {
    ...
    @Query("SELECT * FROM anexo_contrato " +
            ...
            "WHERE temporada_anexo = :temporada AND entra_sitio_no_visitado = 1 ORDER BY especie.desc_especie ASC, anexo_contrato.num_anexo ASC; ")
    List<AnexoCompleto> getSNVByTemporada(int temporada);
