...
public interface MyDao {
    ...
    @Query("SELECT  * FROM fotos WHERE id_visita_foto = :id_visita AND id_ficha_fotos = :idAc")
    List<Fotos> getFotosByIdVisitaAndAnexo(int id_visita, String idAc);
    ...
    @Delete
    void deleteFotos(List<Fotos> fotos);
