...
public class FragmentHarvest extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_estimated_date.setOnClickListener(this);
        btn_real_date.setOnClickListener(this);
        btn_swatching_date.setOnClickListener(this);
        btn_date_harvest.setOnClickListener(this);
        btn_begining_date.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.btn_estimated_date:
                levantarFecha(date_estimated_date);
                break;
            case R.id.btn_real_date:
                levantarFecha(date_real_date);
                break;
            case R.id.btn_swatching_date:
                levantarFecha(date_swatching_date);
                break;
            case R.id.btn_date_harvest:
                levantarFecha(date_date_harvest);
                break;
            case R.id.btn_begining_date:
                levantarFecha(date_begining_date);
                break;
            case R.id.btn_end_date:
                levantarFecha(date_end_date);
                break;
