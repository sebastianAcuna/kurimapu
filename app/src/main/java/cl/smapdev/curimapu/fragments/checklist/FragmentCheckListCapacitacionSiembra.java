...
public class FragmentCheckListCapacitacionSiembra extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_checklist_cap_siembra, container, false);
    }
    ...
    private void bind(View view) {
        ...
        btn_agregar_usuario.setOnClickListener(view1 -> {
            ...
            Fragment prev = requireActivity()
                    .getSupportFragmentManager()
                    .findFragmentByTag(Utilidades.DIALOG_TAG_CAPACITACION_SIEMBRA);
            if (prev != null) {
                ft.remove(prev);
            }
